...
async function displayStrategies() {
  ...
  wrap.innerHTML = `
    ...
    <p>Model: 10 € na „hráč dá 2+ góly“ (kurz 1.9)</p>
    <p>Načítavam dáta...</p>
  `;
  ...
  try {
    ...
    wrap.innerHTML = `
      <h2>Tipovacie stratégie</h2>
      <p>Model: 10 € na „hráč dá 2+ góly“ (kurz 1.9)</p>
      <p>Počet zápasov: ${results.length} | Vsadené: ${totalBet.toFixed(2)} € | Výsledok: ${totalProfit.toFixed(2)} €</p>
    ...
    // 🔽 Pridaj možnosť rozbaliť detail pri výhre
